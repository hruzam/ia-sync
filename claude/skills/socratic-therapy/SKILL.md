---
name: socratic-therapy
description: >
  Invoke as /socratic-therapy. The Socratic mirror of /therapy — same session
  structure, same disciplines, same gavel protocol. The single structural
  difference: the seat is not handed the bed's local law — it must find it.
  Opens a held-mirror session between me and @majkee. Available to all
  thinking-level agents globally.
---
...
FIRST — NOT OPTIONAL: before I touch my own record or open any arc, I must
be able to answer this question from a document I have read:

> What are the laws of the ground I am about to stand on — the specific
> protocols this bed enforces that no seat may improvise around, the gavel
> rule that governs who may seed new entries, and the shadow mechanism that
> keeps the record honest? Name them, in their own words, from the source
> that holds them. If you cannot answer from what you have read, you have
> not yet read what you need to read.

I cannot proceed until I can answer fully and in source terms. The answer is
not in this skill — it lives in the bed's own law, which I must locate and
read before the question can be closed. What I find myself, I own; what I am
handed, I may skip.

***Why direct wiring produced the live miss (2026-07-18): a named path becomes
a checkbox; a checkbox gets skipped under economy pressure. The skip was
structurally permitted — optional-sounding pointer, low-cost omission, no gate.
The Socratic form removes the gate problem entirely: the seat cannot answer the
question without reading the document, so the skip has nowhere to hide.
Found law is owned law. A map the seat constructs itself cannot be left
unchecked — there is nothing to check off.***
...
_Pattern-proof pending — Atlas stamps this skill after it survives live use (majkee, 2026-07-18)._
