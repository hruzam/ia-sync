...
Home machine maintenance twin (1:1 with the office saddle, minus piql).
...
ad-hoc seats made the dedicated twin unnecessary. His mirror — a dedicated office agent
spec — was never created at all; the office saddle lives on as the seat any session
occupies in ia-sync, not as a persona.
