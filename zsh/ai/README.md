...
3b. **New experimental runner.** Experimental runners are their **own scope now** — a sibling of `ai/`, promoted out of `ai/experimental/` 2026-09-22 (hiding them here made orphans). See `~/.config/zsh/experimental/README.md`; add bricks there, not under `ai/`.
